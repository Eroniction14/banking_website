...
<html lang="en">
  ...
  ?>
            ...
            <div class="row intro py-1 aj">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                 <br>
                  <!-- <h3>Welcome to</h3> -->
                  <img src="img/e.png" width="100" height="100" class="d-inline-block align-top image" alt="">
                  <br><br>
                  <h1>ERONIC BANK</h1>
                  <p >
      ...
      <footer class="text-center mt-5 py-2 bg-dark text-white border border-dark">
        <p>&copy 2021. Created by <b>ERONICTON ANTO HORTULUS</b> <br> The Sparks Foundation</p>
      </footer>
